package com.grudnov.lessons.lesson23.hw_transactions;
...
public class TransactionsTask {
    public static void main(String[] args) {
        ...
        Map<String, Long> map = transactionStream.collect(Collectors.
                toMap(transaction -> transaction.getAccount().getNumber(),
                        transaction -> transaction.getSum(), (sum1, sum2) -> sum1 + sum2));
        ...
        transactionStream = Stream.of(transaction1, transaction2, transaction3,
                transaction4, transaction5, transaction6, transaction7);
        long sumTransactions = transactionStream.map(transaction -> transaction.getSum()).reduce((a,b)->a+b).get();
